...
Original file is located at
    https://colab.research.google.com/drive/1Nn6S_B20atXw4eneOSMpcRDdY6kfbC3X
"""
...
def circulo(num_datos=100, R=1, minimo=0, maximo=1, centro_x=0, centro_y=0):
  pi = math.pi
  ...
  x = centro_x + np.cos(theta) * r
  y = centro_y + np.sin(theta) * r
...
#Kazajstán
datos_1 = circulo(
    num_datos=N, R=0.008, minimo=0, maximo=1, centro_x=48.019573, centro_y=66.923684
)
#Río de Janeiro
datos_2 = circulo(
    num_datos=N, R=0.008, minimo=0, maximo=1, centro_x=-22.90642, centro_y=-43.18223
)
